...
2. If you wish to manually trigger the lambda you will have to input the correct catch that would be expected from the
 previous stage of the state machine:
